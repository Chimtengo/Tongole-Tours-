const lodges = [
  {
    ...
    gallerySlug: 'tongole-wilderness-retreat',
    details:
  ...
  },
  {
    ...
    gallerySlug: 'blue-zebra-island-lodge',
    details:
  ...
  },
  {
    ...
    gallerySlug: 'pumulani-lodge',
    details:
      'Pumulani Lodge is an exclusive lakeside retreat set on a lush hillside within a private reserve overlooking the clear waters of Lake Malawi. Guests at Pumulani Lodge can enjoy a variety of activities including snorkeling, kayaking, boat cruises, paddle boarding, and guided nature walks. The lodge also offers opportunities to explore nearby fishing villages and experience the rich local culture of the area. Situated close to Lake Malawi National Park, a UNESCO World Heritage Site famous for its colorful cichlid fish, the lodge is a paradise for nature lovers and water enthusiasts.',
  },
  {
    name: 'Mumbo Island Lodge',
    location: 'Mangochi, Lake Malawi',
    gallerySlug: 'mumbo-island-lodge',
    details:
  ...
  },
  {
    ...
    gallerySlug: 'zomba-forest-lodge',
    details:
...
const lodgeAliasLookup = new Map(
  [
    ...
    ['Pumulani', 'Pumulani Lodge'],
    ['Pumulani Lodge', 'Pumulani Lodge'],
