...
const faqs = [
  ...
  },
  {
    ...
    a: 'Our competitive advantage lies in our niche focus on eco-tourism and community-based tourism, powerful storytelling, strong local partnerships, personalized customer service, and unwavering commitment to sustainability. We offer unique customizable safari experiences with expert guides who have deep local knowledge.',
  },
  {
  ...
  },
  {
    ...
    a: 'We cover all major destinations — Liwonde National Park, Majete Wildlife Reserve, Nkhotakota Wildlife Reserve, Nyika National Park, Lake Malawi islands (Likoma, Cape Maclear, Mumbo Island), Mount Mulanje, Zomba Plateau, and Ntchisi Forest Reserve among others.',
  },
  {
    q: 'How do you support local communities?',
    a: 'Community empowerment is central to our mission. We prioritize local employment, skills training, support local suppliers, promote cultural preservation, and operate the Tongole Foundation which focuses on girls and women empowerment. We use 100% solar power at our facilities.',
  },
  {
    q: 'Can we have a custom itinerary?',
    a: 'Absolutely. We specialize in tailor-made journeys for individuals, couples, families, and groups. Our team will work with you to design the perfect Malawi experience based on your interests, budget, and timeframe.',
  },
]
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="reveal-left">
            ...
            <p className="font-body text-gray-600 text-base leading-relaxed mb-8">
              Find quick answers to common questions about Tongole Tours, our mission,
              our packages, and how we connect travellers to the authentic heart of Malawi.
            </p>
            ...
            <div className="bg-midnight p-8">
              ...
              <p className="font-body text-white/70 text-sm mb-6 leading-relaxed">
                Our team is ready to provide detailed information and support for all your travel inquiries.
              </p>
              <a
                href="/contact"
                className="btn-primary inline-block bg-earth-500 hover:bg-earth-400 text-white px-6 py-3 text-sm font-body tracking-widest uppercase transition-colors"
              >
                Contact Us
              </a>
            </div>
          ...
          <div className="reveal-right space-y-3">
            {faqs.map((faq, i) => (
              <div
                key={i}
                className="border border-earth-200 bg-white overflow-hidden"
              >
                <button
                ...
                >
                  ...
                  <span
                    className={`text-earth-400 font-body text-xl flex-shrink-0 transition-transform duration-300 ${
                      open === i ? 'rotate-45' : ''
                    }`}
                  >
                    +
